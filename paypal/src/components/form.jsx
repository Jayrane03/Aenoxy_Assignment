...
const Form = () => {
  ...
  <input type="text" className="form-input" placeholder="First Name*" />
      ...
      <select className="form-select form-input" >
      <option value="" disabled selected>Select Anual Sales</option>
      </select>
      <select className="form-select form-input" >
      <option value="" disabled selected>Do you already have an Paypal business account</option>
      ...
      <p className="m-4 w-50 text-xs text-left">I consent to PayPal contacting me by phone or email, and sending me product or industry relevent to my query. I know I can unsubscribe at any time.</p>
